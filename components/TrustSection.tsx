...
const stats = [
  ...
  { number: '8MW', label: 'Power Generated' },
  { number: '4.9', label: 'Star Rating' },
];

export default function TrustSection() {
  return (
    <section className="py-20 bg-gradient-to-br from-amber-900 via-amber-950 to-orange-950">
      <div className="max-w-6xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
          Your Neighbors Are Already Saving
        </h2>
        <p className="text-white/70 mb-12 max-w-2xl mx-auto">
          Look around your neighborhood — chances are someone on your street is generating free power with us.
        </p>

        <div className="flex flex-wrap justify-center gap-16 mb-12">
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              <span className="block text-5xl sm:text-6xl font-extrabold text-amber-400">
                {stat.number}
              </span>
